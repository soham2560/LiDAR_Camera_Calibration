...
#include <deque>
#include <calc_tools/common/raw_points.hpp>
...
public:
   ...
   */
  bool process(const calc_tools::RawPoints::Ptr& points);
...
private:
  void replace_points_stamp(const calc_tools::RawPoints::Ptr& points);
